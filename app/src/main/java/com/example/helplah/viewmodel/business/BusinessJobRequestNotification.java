 ...
 * the business job request fragment but only shows one job request.
 *
 ...
 */
public class BusinessJobRequestNotification extends BusinessJobsRequestsFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.rootView = inflater.inflate(R.layout.business_job_request_notification_fragment, container, false);
